...
for employee in client_data['income_type'].unique():
    ...
    client_data.loc[(client_data['income_type'] == employee) & (
        client_data['total_income'].isnull()), 'total_income'] = median_income
...
family_status = client_data
family_status = family_status.pivot_table(index='family_status', columns='debt', values='total_loans', aggfunc='count', margins=True, margins_name='total_loans')
print(family_status)
